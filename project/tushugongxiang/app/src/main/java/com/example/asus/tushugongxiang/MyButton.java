...
public class MyButton extends android.support.v7.widget.AppCompatButton{
    ...
    public void setButton(String bg,String bgc,String t,String tc,boolean f,float r)
    {
        setFillet(f);
        if(f==true)setRadius(r);
        if(bg!=null)setBackColor(bg);
        if(bgc!=null)setBackColorSelected(bgc);
        if(t!=null)setTextColors(t);
        if(tc!=null)setTextColorSelected(tc);
